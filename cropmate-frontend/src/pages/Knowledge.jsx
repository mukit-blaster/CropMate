...
const Knowledge = () => {
  ...
  return (
    <div className="min-h-screen bg-gray-50 font-sans pb-24">
      {/* ================= HERO HEADER ================= */}
      <div className="relative bg-green-700 text-white pt-10 pb-20 px-4 rounded-b-[2.5rem] shadow-xl overflow-hidden">
        ...
        <div className="absolute top-0 left-0 w-64 h-64 bg-emerald-400 rounded-full mix-blend-multiply filter blur-3xl opacity-20 animate-blob animation-delay-2000"></div>

        <div className="max-w-4xl mx-auto text-center relative z-10">
          <div className="inline-flex items-center gap-2 bg-green-800/50 px-4 py-1.5 rounded-full text-green-200 text-sm font-semibold mb-6 border border-green-600 backdrop-blur-sm">
          ...
          <p className="text-green-100 text-lg max-w-xl mx-auto">
            Discover proven techniques to increase your yield and protect your
            crops.
          </p>
        </div>
        ...
        <div className="max-w-xl mx-auto mt-8 relative">
          ...
          <input
            ...
            className="w-full pl-11 pr-4 py-4 rounded-2xl text-gray-800 focus:outline-none focus:ring-4 focus:ring-green-500/30 shadow-lg placeholder-gray-400 font-medium"
            value={searchTerm}
      ...
      <div className="max-w-6xl mx-auto px-4 mt-8">
        {/* Category Pills */}
        <div className="flex overflow-x-auto gap-3 pb-6 scrollbar-hide justify-start md:justify-center">
          {categories.map((cat) => (
            <button
              key={cat}
              onClick={() => setActiveCategory(cat)}
              className={`px-5 py-2.5 rounded-full whitespace-nowrap font-bold text-sm transition-all duration-200 ${
                activeCategory === cat
          ...
          {filteredTips.map((tip) => (
            ...
            >
              ...
              <div className="p-6 flex flex-col flex-grow">
                ...
                <h3 className="text-lg font-bold text-gray-800 mb-2 leading-tight group-hover:text-green-700 transition-colors">
                  {tip.title}
                </h3>
                ...
                <button
                  ...
                  className="w-full py-2.5 rounded-xl text-sm font-bold transition-colors bg-gray-50 text-gray-600 hover:bg-green-50 hover:text-green-700 flex items-center justify-center gap-2"
                >
