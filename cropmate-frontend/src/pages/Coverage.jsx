...
const Coverage = () => {
  ...
  return (
    <div className="bg-[#F5F7FA] min-h-screen py-6 px-4 relative">
      <div className="max-w-6xl mx-auto bg-white rounded-2xl p-6 shadow-md relative z-10">
        <h2 className="text-2xl md:text-3xl font-bold text-[#0A2A3F] mb-5">
        ...
        <form onSubmit={handleSearch} className="flex items-center gap-2 w-full max-w-lg">
          <div className="flex items-center bg-white border rounded-full px-3 py-1.5 w-full shadow-sm">
            <svg className="h-4 w-4 text-gray-400 mr-2" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
              <g strokeLinejoin="round" strokeLinecap="round" strokeWidth="2.3" fill="none" stroke="currentColor">
                <circle cx="11" cy="11" r="8"></circle>
                <path d="m21 21-4.3-4.3"></path>
              </g>
            </svg>
            <input type="search" name="location" placeholder="Search here" className="w-full outline-none text-sm text-gray-700" />
          </div>
          <button type="submit" className="bg-[#A9D92F] px-4 py-1.5 rounded-full text-sm text-[#0A2A3F] font-semibold hover:bg-[#98c52b] transition active:scale-95 transform">
            Search
          </button>
        </form>

        <h3 className="mt-6 mb-3 text-base font-semibold text-[#0A2A3F]">
          We deliver almost all over Bangladesh
        </h3>

        <div className="w-full h-[420px] rounded-xl overflow-hidden border border-gray-200 shadow-md relative z-0">
