...
const ClientLogos = () => (
  <section className="bg-gray-100 pt-6 pb-8 my-3 rounded-2xl">
    <div className="max-w-6xl mx-auto text-center mb-5">
      ...
      <p className="text-tertiary text-sm mt-1 px-4">
    ...
    <Marquee pauseOnHover gradient={false} speed={50}>
      {partners.map((partner) => (
        ...
        >
          <partner.icon
            className="text-3xl md:text-4xl transition-opacity duration-300 cursor-pointer opacity-70 hover:opacity-100"
